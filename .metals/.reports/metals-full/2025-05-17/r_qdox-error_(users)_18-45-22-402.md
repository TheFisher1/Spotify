error id: file://<WORKSPACE>/users/src/main/java/bg/spotify/users/security/JwtUtil.java
file://<WORKSPACE>/users/src/main/java/bg/spotify/users/security/JwtUtil.java
...
```java
offset: 0
uri: file://<WORKSPACE>/users/src/main/java/bg/spotify/users/security/JwtUtil.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/users/src/main/java/bg/spotify/users/security/JwtUtil.java