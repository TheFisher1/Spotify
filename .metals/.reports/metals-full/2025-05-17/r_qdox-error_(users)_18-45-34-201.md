error id: file://<WORKSPACE>/users/src/main/java/bg/spotify/users/service/UserService.java
file://<WORKSPACE>/users/src/main/java/bg/spotify/users/service/UserService.java
...
```java
offset: 0
uri: file://<WORKSPACE>/users/src/main/java/bg/spotify/users/service/UserService.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/users/src/main/java/bg/spotify/users/service/UserService.java